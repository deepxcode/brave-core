...
export class Panel extends React.Component<Props, State> {
  ...
  startRewards () {
    ...
    chrome.braveRewards.getScheduledCaptchaInfo((scheduledCaptcha: RewardsExtension.ScheduledCaptcha) => {
      this.props.actions.onGetScheduledCaptchaInfo(scheduledCaptcha)
    })
